...
if true; then
    ...
    # bash run_c7.sh c7_gamma_E1e11_z0 2500 1 100 0 0 214700 240 1000 5
    ...
    # bash run_c7.sh c7_proton_E1e10_z0 5000 14 10 0 0 214700 240 1000 5
    # bash run_c7.sh c7_proton_E1e11_z0 2500 14 100 0 0 214700 240 1000 5
...
if true; then
    ...
    # bash run.sh c8_gamma_E1e11_z0 22 100 119999.9 0 2500 1
    ...
    # bash run.sh c8_proton_E1e10_z0 2212 10 119999.9 0 5000 1
    # bash run.sh c8_proton_E1e11_z0 2212 100 119999.9 0 2500 1
...
if true; then
    ...
    # python3 convert_parquet_eventio.py output/c8_gamma_E1e11_z0 output/c8_gamma_E1e11_z0/output.corsika
    ...
    # python3 convert_parquet_eventio.py output/c8_proton_E1e10_z0 output/c8_proton_E1e10_z0/output.corsika
    # python3 convert_parquet_eventio.py output/c8_proton_E1e11_z0 output/c8_proton_E1e11_z0/output.corsika
...
if true; then
    # python3 -W ignore plotEventIO.py gamma_E1e10_z0 output/c7_gamma_E1e10_z0 output/c8_gamma_E1e10_z0
    # python3 -W ignore plotEventIO.py gamma_E1e11_z0 output/c7_gamma_E1e11_z0 output/c8_gamma_E1e11_z0
    ...
    # python3 -W ignore plotEventIO.py proton_E1e10_z0 output/c7_proton_E1e10_z0 output/c8_proton_E1e10_z0
    # python3 -W ignore plotEventIO.py proton_E1e11_z0 output/c7_proton_E1e11_z0 output/c8_proton_E1e11_z0
