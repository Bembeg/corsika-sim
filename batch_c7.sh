...
if true; then
    ...
    bash run_c7.sh c7_proton_E1e12_z0 5000 14 1000 0 0 214700 240 1000 5
...
if true; then
    bash run.sh c8_gamma_E1e12_z0 22 1000 119999.9 0 5000 1
    ...
    bash run.sh c8_proton_E1e12_z0 2212 1000 119999.9 0 5000 1
